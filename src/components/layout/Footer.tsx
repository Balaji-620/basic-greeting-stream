...
export function Footer() {
  ...
  const ctaButtons = [
    { text: "Start My Career Journey", href: "#", primary: true },
    { text: "Explore Knowledge Hub", href: "#" },
    { text: "Join Our Community", href: "#" },
    { text: "Schedule Mentorship", href: "#" },
  ];

  return (
    <footer className="bg-[#0F1026] text-white">
      {/* CTA Section */}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            {ctaButtons.map((button) => (
              <Link
                key={button.text}
                to={button.href}
                className={`group flex items-center justify-center px-6 py-3 rounded-full font-medium transition-all duration-300 ${
                  button.primary
