...
import { Cpu, Server, Database, Monitor, BarChart3, Link } from "lucide-react"; // Fixed missing icon imports

const journeySteps = [  // Renamed to journeySteps to match usage
  {
    ...
    <section className="py-20 bg-gradient-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {journeySteps.map((tech, index) => (  // Changed to journeySteps
            <motion.div  // Added motion component
              key={tech.layer}
        ...
        <div className="text-center mt-16">
          <button className="bg-gradient-to-r from-brand-cyan to-brand-blue hover:from-brand-blue hover:to-brand-cyan text-white px-8 py-3 rounded-full font-montserrat font-medium hover:scale-105 transition-all duration-300">
